...
export const ARTICLES: Article[] = [
  {
    ...
    seoTitle: "Qué es un camión vacuum y para qué sirve",
    description: "Qué es un camión vacuum, cómo funciona el sistema de vacío, qué fluidos succiona (lodos, borras, efluentes) y cuándo contratarlo en Venezuela.",
  ...
  },
  {
    ...
    seoTitle: "Frac tank: qué es y cuándo alquilarlo",
    description: "Qué es un frac tank, cuánto almacena un tanque de 500 barriles, qué configuraciones existen y cuándo conviene alquilarlo en operaciones petroleras.",
  ...
  },
  {
    ...
    seoTitle: "Cómo recuperar crudo de una fosa petrolizada",
    description: "Qué es una fosa petrolizada, por qué el crudo se solidifica y cómo la recuperación térmica con vapor lo devuelve a producción: proceso, equipos y capacidad.",
  ...
  },
  {
    ...
    seoTitle: "Hydroblasting vs sandblasting: cuál usar",
    description: "Diferencias entre hydroblasting (agua a 20.000 y 40.000 PSI) y sandblasting: seguridad en áreas clasificadas, residuos, aplicaciones y cuándo conviene cada uno.",
  ...
  },
  {
    ...
    seoTitle: "Decreto 2635 y desechos petroleros",
    description: "Qué regula el Decreto 2635 en Venezuela, cómo se clasifican los desechos petroleros y qué documentación exige: manifiesto y certificado de disposición final.",
  ...
  },
  {
    ...
    seoTitle: "Desnatado y bombeo de crudo pesado",
    description: "Cómo funciona el desnatado de crudo con plato recolector y bomba de tornillo hidráulica, por qué no emulsiona el crudo y qué capacidad alcanza: 1,500 Bbl/día.",
  ...
  },
  {
    ...
    seoTitle: "Alquiler de calderas e inyección de vapor",
    description: "Para qué sirve alquilar un generador de vapor OTSG: calentamiento de tanques y patios de tanques, sellos en carga de buques y estimulación de pozos.",
